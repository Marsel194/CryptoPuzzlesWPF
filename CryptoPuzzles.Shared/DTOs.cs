...
namespace CryptoPuzzles.Shared
{
    ...
    public class ADifficulty : INotifyPropertyChanged
    {
        ...
        public string DifficultyName { get => _difficultyName; set => SetProperty(ref _difficultyName, value); }
    ...
    public class APuzzle : INotifyPropertyChanged
    {
        ...
        public int MaxScore { get => _maxScore; set => SetProperty(ref _maxScore, value); }
        ...
        public int? TutorialOrder { get => _tutorialOrder; set => SetProperty(ref _tutorialOrder, value); }
        ...
        public string? CreatedByAdminName { get => _createdByAdminName; set => SetProperty(ref _createdByAdminName, value); }
    ...
    public class AGameSession : INotifyPropertyChanged
    {
        ...
        public string SessionType { get => _sessionType; set => SetProperty(ref _sessionType, value); }
        ...
        public int PuzzlesCount { get => _puzzlesCount; set => SetProperty(ref _puzzlesCount, value); }

        [ExportName("Решено")]
        public int SolvedCount { get => _solvedCount; set => SetProperty(ref _solvedCount, value); }

        [ExportName("Текущий шаг")]
        public int? CurrentTutorialIndex { get => _currentTutorialIndex; set => SetProperty(ref _currentTutorialIndex, value); }
    ...
    public class ATutorial : INotifyPropertyChanged
    {
        ...
        public string TheoryTitle { get => _theoryTitle; set => SetProperty(ref _theoryTitle, value); }
    ...
    public class AUser : INotifyPropertyChanged
    {
        ...
        public int PuzzlesSolved { get => _puzzlesSolved; set => SetProperty(ref _puzzlesSolved, value); }
    ...
    public class ASessionProgress : INotifyPropertyChanged
    {
        ...
        [ExportName("Порядок")]
        public int PuzzleOrder { get => _puzzleOrder; set => SetProperty(ref _puzzleOrder, value); }

        public bool Solved { get => _solved; set => SetProperty(ref _solved, value); }

        [ExportName("Использовано подсказок")]
        public int HintsUsed { get => _hintsUsed; set => SetProperty(ref _hintsUsed, value); }

        [ExportName("Заработано очков")]
        public int ScoreEarned { get => _scoreEarned; set => SetProperty(ref _scoreEarned, value); }

        [ExportName("Начало")]
        public DateTime StartedAt { get => _startedAt; set => SetProperty(ref _startedAt, value); }

        [ExportName("Время решения")]
        public DateTime? SolvedAt { get => _solvedAt; set => SetProperty(ref _solvedAt, value); }

        [ExportName("Затраченное время")]
        public TimeSpan? TimeToSolve { get => _timeToSolve; set => SetProperty(ref _timeToSolve, value); }
    ...
    public class AUserStatistic : INotifyPropertyChanged
    {
        ...
        [ExportName("Решено головоломок")]
        public int TotalPuzzlesSolved { get => _totalPuzzlesSolved; set => SetProperty(ref _totalPuzzlesSolved, value); }

        [ExportName("Всего очков")]
        public int TotalScore { get => _totalScore; set => SetProperty(ref _totalScore, value); }

        [ExportName("Всего подсказок")]
        public int TotalHintsUsed { get => _totalHintsUsed; set => SetProperty(ref _totalHintsUsed, value); }

        [ExportName("Средний балл за сессию")]
        public decimal AvgScorePerSession { get => _avgScorePerSession; set => SetProperty(ref _avgScorePerSession, value); }

        [ExportName("Последняя активность")]
        public DateTime? LastActive { get => _lastActive; set => SetProperty(ref _lastActive, value); }

        [ExportName("Дата регистрации")]
        public DateTime? RegisteredAt { get => _registeredAt; set => SetProperty(ref _registeredAt, value); }
    ...
    public record APuzzleUpdate(int Id, string Title, string Content, string Answer, int MaxScore,
        int DifficultyId, int? MethodId, bool IsTraining, int? TutorialOrder, bool? IsDeleted, DateTime? DeletedAt) : IHasId;
