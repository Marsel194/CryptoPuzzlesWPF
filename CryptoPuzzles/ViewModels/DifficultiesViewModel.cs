...
{
    public class DifficultiesViewModel : EntityViewModelBase<AEncryptionMethod, AEncryptionMethodCreate, AEncryptionMethodUpdate>
    {
        public DifficultiesViewModel(EncryptionMethodApiService apiService) : base(apiService) { }
